...
import { clearAllHistoryData, getHistoryData, onHistoryRestore, restoreHistoryData } from '../../../redux/slices/restApiSlice';
...
export const History = () => {
    ...
    const handleClearAll = () => {
        setTimeout(() => setDeleteAll(false), 10);
    ...
    return (
        <>
            <div className='max-w-[90%] h-full flex flex-col gap-1 border border-transparent'>
                <div className="max-w-[98%] text-stone-400 border-b border-b-dividerDark flex justify-between align-middle items-center">
                    ...
                    <div className="flex gap-2">
                        ...
                        <MdOutlineDeleteOutline size={16} className='cursor-pointer' onClick={() => setDeleteAll(true)} />
            ...
            {isDeleteAll && <ConfirmationModal text='Are you sure you want to delete all history permanently' handleDelete={handleClearAll} handleCancel={() => setDeleteAll(false)} />}
        </>
    )
}
