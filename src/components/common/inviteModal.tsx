...
export const InviteModal = ({ handleClose }: any) => {
    const mediaList = [
        ...
        { label: 'Reddit', icon: <img src={redditImg} className='text-accentDark w-7 object-contain' alt='reddit' />, link: 'https://www.reddit.com/submit?url=https://hoppscotch.io&title=Hoppscotch%20-%20Open%20source%20API%20development%20ecosystem.' },
